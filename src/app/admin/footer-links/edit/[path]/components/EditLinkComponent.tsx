      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="flex justify-between">
            <h2 className="text-xl mb-4 font-bold text-center font-secondary text-primary">Edit Link</h2>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Enter path for the page" className="font-primary" {...field} />
                    </FormControl>
                    <FormDescription className="text-[10px]">
                      Slug to be used in{" "}
                      <code className="bg-slate-100 px-1 rounded-sm">

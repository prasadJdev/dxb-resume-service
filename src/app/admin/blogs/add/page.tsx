...
function AddBlogPage() {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: { title: "", shortDescription: "", slug: "", keywords: [], image: "", body: {} },
  });
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="flex justify-between">
            <h2 className="text-xl mb-4 font-bold text-center font-secondary text-primary">Add new blog</h2>

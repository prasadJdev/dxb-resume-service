...
function HeroSection() {
  return (
    <section
      id="hero-section"
      className="flex items-center justify-center flex-col md:flex-row px-4 sm:px-12 p-4 sm:p-8 md:p-12 lg:p-16 sm:py-8 md:py-12 xl:py-24 bg-cover"
      style={{
    ...
    >
      <div className=" max-w-lg">
        <h1 className="font-secondary text-[2.5rem] leading-[1.4] font-semibold m-0 mb-6 lg:pr-24 md:pr-20 text-white">
          Increase your chances of getting interviews with an ATS-friendly CV
        </h1>

        <p className="font-secondary mb-6 text-3xl lg:pr-24 h-[108px] text-white">
        ...
        <div className="flex gap-8">
          ...
          <Link
            href="#pricing"
            className="px-6 py-4 bg-secondary text-white text-xl rounded-md font-semibold hover:bg-secondary/80 hover:shadow-lg flex items-center justify-center"
          >
            Explore Our Pricing
            <ChevronsRight />
          </Link>
      ...
      <div className="relative w-[620px] h-[320px] max-w-lg flex-1 z-[1]">

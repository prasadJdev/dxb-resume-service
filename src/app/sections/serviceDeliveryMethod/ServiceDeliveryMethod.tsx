...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-10 text-secondary dark:text-neutral-400">{icon}</div>
      <div className="text-md font-secondary font-bold mb-2 relative z-10 px-10">
      ...
      <p className="text-sm text-primary/90 font-primary dark:text-neutral-300 max-w-xs relative z-10 px-10">
        {description}
      </p>
    </div>
  );
